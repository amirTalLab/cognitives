...
import { COMPOSITE_FACE_PORT, VISUAL_SEARCH_PORT, BOUBA_KIKI_PORT, DRM_PORT, MENTAL_REP_PORT, SUMMARY_STATS_PORT, LOGICS_PORT, CREATIVITY_PORT, BRMS_PORT, TWO_STEP_PORT, POSNER_CUEING, SERIAL_ORDER_PORT, SRT_PORT, STROOP_PORT, WORD_SUPERIORITY_PORT } from './ports';
...
const BUILT_IN: ExperimentDefinition[] = [
  ...
  SERIAL_ORDER_PORT, SRT_PORT, COMPOSITE_FACE_PORT, VISUAL_SEARCH_PORT, MENTAL_REP_PORT, SUMMARY_STATS_PORT, LOGICS_PORT, CREATIVITY_PORT, BRMS_PORT, TWO_STEP_PORT,
];
