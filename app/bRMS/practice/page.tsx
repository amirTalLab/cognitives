...
export default function BRMSPracticePage() {
  ...
  const t = isHe ? {
    ...
    tapLeft: '◀',
    tapRight: '▶',
    rotateMsg: 'סובבי את הטלפון לרוחב',
    instrTitle: 'תרגול',
    instrBody: 'ריבועים צבעוניים יהבהבו על המסך. פנים יופיעו בהדרגה משמאל או מימין לסימן ה-+. ברגע שתבחיני בפנים — לחצי על הצד שבו הן הופיעו.',
    instrFix: 'שמרי מבט על ה-+ שבמרכז המסך לכל אורך המשימה.',
    instrTip: 'לחצי על חצי המסך השמאלי או הימני, או השתמשי במקשי החצים.',
    instrStart: 'התחילי תרגול',
  } : {
    practice: 'Practice',
    trialOf: `${idx + 1} / ${TOTAL}`,
    correct: '✓ Correct!',
