...
export default function BRMSExperimentPage() {
  ...
  const t = isHe ? {
    ...
    tapRight: '▶',
    breakTitle: 'הפסקה',
    breakMsg: (n: number) => `השלמת ${n} מתוך ${TOTAL} תורות. קחי רגע ולחצי כשתהיי מוכנה.`,
    breakContinue: 'המשיכי',
    rotateMsg: 'סובבי את הטלפון לרוחב',
    instrTitle: 'המשימה מתחילה',
    instrBody: 'עכשיו מתחילה המשימה האמיתית. הכול זהה — לחצי על הצד שבו מופיעות הפנים, מהר ככל האפשר.',
    instrFix: 'שמרי מבט על ה-+ שבמרכז המסך.',
